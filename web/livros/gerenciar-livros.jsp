            ...
            <div class="card-content">
                ...
                <div class="card-info">
                    <div style="display: flex; flex-direction: column; gap: 15px;">
                        ...
                        <span><%= livroAtual.getEditora() != null ? livroAtual.getEditora() : "Editora Desconhecida"%></span>
                        <span><strong>Data de Publicação:</strong></span>
                        <span><%= livroAtual.getDataPublicacao()%></span>
                        <% if (livroAtual.getQuantidadeTotal() > 0) {%>
                        <span><strong>Quantidade Disponível:</strong></span>
                        <span><%= livroAtual.getQuantidadeDisponivel()%> / <%= livroAtual.getQuantidadeTotal()%></span>
                        <% }%>
                    </div>
                </div>
