        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            switch (operacao) {
                ...
                case 2 -> {
                    ...
                    l.setImagemUrl(request.getParameter("imagem_url"));
                    l.setDataPublicacao(request.getParameter("data_publicacao"));
                    l.setQuantidadeTotal(Integer.parseInt(request.getParameter("quantidade_total")));
                    l.setQuantidadeDisponivel(Integer.parseInt(request.getParameter("quantidade_total")));
...
//              Editar Livros
                case 7 -> {
                    ...
                    livroParaEditar.setQuantidadeTotal(quantidadeTotal);
